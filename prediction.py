...
# GRAPH-3: Education level of all candidates

# Calculate the number of candidates for each education level
...
plt.title('Education Level Distribution of Candidates')
